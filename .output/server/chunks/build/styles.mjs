...
const styles = {
  "pages/index.vue": () => import('./index-styles.yLoDDYfK.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=86d46900&lang.css": () => import('./index-styles.C633UI8P.mjs').then(interopDefault),

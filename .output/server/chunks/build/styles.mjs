...
const styles = {
  "pages/index.vue": () => import('./index-styles.DU_re8rI.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=bf23aba1&lang.css": () => import('./index-styles.DEL4F-qF.mjs').then(interopDefault),

...
const styles = {
  "pages/index.vue": () => import('./index-styles.DCHpsWnu.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=79c79a72&lang.css": () => import('./index-styles.-5j2sARY.mjs').then(interopDefault),

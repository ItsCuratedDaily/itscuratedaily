...
const styles = {
  "pages/index.vue": () => import('./index-styles.Db0rexi0.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=74c3db0a&lang.css": () => import('./index-styles.Bt3jupqu.mjs').then(interopDefault),

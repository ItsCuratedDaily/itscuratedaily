...
const styles = {
  "pages/index.vue": () => import('./index-styles.l4POmN_O.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=c4a48be1&lang.css": () => import('./index-styles.l4POmN_O.mjs').then(interopDefault),

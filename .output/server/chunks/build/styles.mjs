...
const styles = {
  "pages/index.vue": () => import('./index-styles.DIr0Qh9j.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=bdf9e51f&lang.css": () => import('./index-styles.C6fOm0qt.mjs').then(interopDefault),

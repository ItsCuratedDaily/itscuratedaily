...
const styles = {
  "pages/index.vue": () => import('./index-styles.Mna3z_8J.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=41c689c8&lang.css": () => import('./index-styles.Bgt_Qqbq.mjs').then(interopDefault),

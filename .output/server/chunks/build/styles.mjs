...
const styles = {
  "pages/index.vue": () => import('./index-styles.DPqTjB9s.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=1&scoped=87d9ff61&lang.css": () => import('./index-styles.8LC7GuLt.mjs').then(interopDefault),
